...
@Value.Immutable
public abstract class TSConstant implements TSConstantElement {
    ...
    @Override
    public void accept(TSConstantVisitor visitor, int ident) {
        visitor.visit(this, ident);
    }

    public TSConstant changedTSTarget(TSTargetType newTargetType) {
        return TSConstantBuilder.copyOf(this).withType(newTargetType);
    }
}
