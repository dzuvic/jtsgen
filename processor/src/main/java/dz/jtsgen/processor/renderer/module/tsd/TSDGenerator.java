...
public class TSDGenerator {
    ...
    public void writeTypes(TSModule module) throws IOException {
        TSNameSpace nameSpace = convertToNameSpace(module.getForModule());
        FileObject dts_file_object = ModuleResourceHelper.createResource(env,module,module.getModuleTyingsFile());

        try (PrintWriter out = new PrintWriter(dts_file_object.openWriter())) {
    ...
    private void writeNamespace(TSModule module, TSNameSpace nameSpace, PrintWriter out) {
    ...
    private void writeNameSpaces(TSModule module, TSNameSpace ns, int ident, PrintWriter out) {
        if (ns.isRoot()) {
    ...
    private void outputTypes(TSModule module, int ident, List<TSType> types, PrintWriter out) {
    ...
    private void writeHeader(TSModule module, PrintWriter out) {
    ...
    private void writeUMD(TSModule module, PrintWriter out) {
